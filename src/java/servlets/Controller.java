...
public class Controller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("home")) {
            ...
            String number = request.getParameter("nubmer");
            ...
            if (position == null || position.isEmpty()) {
                ...
                isbn = Double.parseDouble(position);
            }

            // store data in an Employee object
            Employee employee = new Employee(0, number, lastName , firstName, position);

            // validate the parameters
            if (number == null || lastName == null || firstName == null
                    || position == null || number.isEmpty()
            ...
            // store data in an Employee object
            Employee employee = new Employee(empId, number, lastName, firstName, position);

            // validate the parameters
            if (empIdString == null || number == null || lastName == null
                    || firstName == null || position == null
                    || empIdString.isEmpty() || number.isEmpty()
                    || lastName.isEmpty() || firstName.isEmpty()
                    || position.isEmpty()) {
                request.setAttribute("employee", employee);
                url = "/updateRecord2.jsp";
